...
df.to_json(f'data/fixtures/wrexham_game_logs_league_one_{season}.json', indent=4, orient='records')
df.to_csv(f'data/fixtures/wrexham_game_logs_league_one_{season}.csv', index=False)